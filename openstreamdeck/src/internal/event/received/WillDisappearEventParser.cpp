...
#include "WillDisappearEventParser.h"

#include "EventKeys.h"
#include "event/WillDisappearEvent.h"

namespace openstreamdeck::internal::event {

WillDisappearEventParser::WillDisappearEventParser() : EventParser(kWillDisappearEvent) {
}

auto WillDisappearEventParser::parseEvent(const boost::json::object &json) const -> std::unique_ptr<Event> {
    ...
    return std::make_unique<WillDisappearEvent>(
